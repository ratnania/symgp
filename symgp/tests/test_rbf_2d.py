...
def test_kernel_2d_2():
    ...
    expected = (phi**2 - phi*theta_1*(2*xi - 2*xj) - phi*theta_2*(2*yi - 2*yj) +
    ...
    expected = (phi**2 - phi*theta_1*(-2*xi + 2*xj) - phi*theta_1*(2*xi - 2*xj) +
                4*phi*theta_2*(2*theta_2*(yi - yj)**2 - 1) +
                4*theta_1*theta_2*(xi - xj)*(-2*theta_2*(yi - yj)**2 + 1) +
                4*theta_1*theta_2*(xi - xj)*(2*theta_2*(yi - yj)**2 - 1) +
                2*theta_1*(-2*theta_1*(xi - xj)**2 + 1) +
                4*theta_2**2*(4*theta_2**2*(yi - yj)**4 -
                              12*theta_2*(yi - yj)**2 + 3))*exp(-theta_1*(xi - xj)**2 - theta_2*(yi - yj)**2)
    assert(K == expected)
    # ...
